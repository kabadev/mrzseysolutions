...
export default function AddRiderForm() {
  ...
  useEffect(() => {
    setNewRiderinfo({
      passportType: watchedFields.passportType || "PC",
      passportNumber: "PC000000",
      surname: watchedFields.surname || "Sample Surname",
      givenName: watchedFields.givenName || "Sample Given Names",
      nationality: "GAMBIAN",
      birthDate: watchedFields.birthDate || "2005-05-09",
